        ...
        <div className={cx('footer-body-content')}>
          <div className={cx('footer-body-content-1')}>
            ...
            <p className={cx('text-2')}>
              TRẦN GIA là công thiết kế in ấn tại Hà Nội cam kết mang đến <br /> cho
              bạn những sản phẩm in ấn chất lượng cao nhất với giá cả <br/> cạnh tranh
              và dịch vụ khách hàng tốt nhất. Chúng tôi nhận in<br /> và vận chuyển
